...
public class Community_fragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        addsubcommitem(getResources().getDrawable(R.drawable.cafe1), getResources().getDrawable(R.drawable.ic_profile),"김준희", "Be, Bridge", "강원도 영월군 김삿갓면 주문리 6-1", "카페가 넓고 엄청 고급지게 생겼어요. 거리가 멀다는게 좀 흠", "7", "11");
        addsubcommitem(getResources().getDrawable(R.drawable.cafe2), getResources().getDrawable(R.drawable.ic_profile),"커피돌이", "Cafe청담", "서울특별시 청담동 선릉로 162길 51", "정동극장 기다리다 잠깐 들어왔는데 분위기 완전 좋아요~", "6", "14");
        addsubcommitem(getResources().getDrawable(R.drawable.cafe3), getResources().getDrawable(R.drawable.ic_profile),"커피중독자", "PS카페", "서울특별시 신사동 도산대로 49길", "싱가포르 분위기 카페라고해서 와봤어요~ 이국적인 분위기가 엄청 좋네요", "11", "17");

    }

    private void addsubcommitem(Drawable cafe_img, Drawable writer_profile, String writer_name, String cafe_name, String cafe_address, String review, String comment_num, String like_num) {
