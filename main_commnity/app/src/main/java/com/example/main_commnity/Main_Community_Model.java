...
public class Main_Community_Model {
    private int profile, cafe_image;
    String writer_name, cafe_name, cafe_review, score_num, comment_num, like_num;

    public Main_Community_Model(int profile, int cafe_image, String writer_name, String cafe_name, String cafe_review, String score_num, String comment_num, String like_num){
